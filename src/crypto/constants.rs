...
// C# samples indices 0,16,32,48,64,80,96,112 into key[0,4,8,12,16,20,24,28].
pub fn trimmed_user_key() -> [u8; 32] {
    let mut key = [0u8; 32];
    for i in 0..8 {
        key[i * 4] = UserKey[i * 16];
    }
    key
}

pub const WZ_GMSIV: [u8; 4] = [0x4D, 0x23, 0xC7, 0x2B];       // GMS
...
#[rustfmt::skip]
pub static SHUFFLE_TABLE: [u8; 256] = [
